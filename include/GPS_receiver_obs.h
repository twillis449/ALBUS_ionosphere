...
public:
    GPS_receiver_obs(const Uint32 N_TIMES, const Uint32 N_SAT,
                     ...
                     const Real32* const stec_data,    // m^{-2}
                     const Real32* const sigma_data,   // m^{-2}
    ...
    Sint32 get_model_data(const Uint32 t, const Uint32 s,
                          Real32* model_STEC) const throw();
    Sint32 set_model_data(const Uint32 t, const Uint32 s,
                          Real32 model_STEC) throw();
...
private:
    ...
    Real32* data;
    Real32* data_sigma;
    Real32* data_model_STEC;          // some model's STEC value
