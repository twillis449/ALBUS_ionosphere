...
c
      ...
      CHARACTER*256 BPATH
      PARAMETER(BPATH=
     &     '/jop30_0/anderson/astro/ionosphere/prog/FORTRAN/IRI')
...
c 
        ...
        call iri_web_ne(BPATH,jmag,jf,xlat,xlon,iy,mmdd,iut,hour,
...
1234    xcor=xcor+vstp
        ...
        call IRIT13NE(BPATH,52.0,6.0,jmag,jf,
     &     2005,602,15.0,50.0,25000.0,
     &                          tec,tecb,tect)
        print *,tec, tecb, tect
            stop
            end
