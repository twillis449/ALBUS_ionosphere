...
C
C  METHOD
C     The user is asked for the root name of a formatted USU PIM database
C     file, the root name of the unformatted USU PIM database files to be
...
C
C  FILES ACCESSED
C     Unit 1   Formatted USU PIM database files
C     Unit 2   Unformatted USU PIM database files
C
C  AUTHOR
C     Lincoln Brown
...
C
      READ(1,300) (REC(I),I=1,3)
      WRITE(2,REC=1) (REC(I),I=1,3)
      READ(1,300) (REC(I),I=1,4)
      WRITE(2,REC=2) (REC(I),I=1,4)
      READ(1,300) (REC(I),I=1,2)
      WRITE(2,REC=3) (REC(I),I=1,2)
      READ(1,300) (REC(I),I=1,3)
      WRITE(2,REC=4) (REC(I),I=1,3)
      READ(1,300) (REC(I),I=1,3)
      WRITE(2,REC=5) (REC(I),I=1,3)
      READ(1,300) (REC(I),I=1,3)
      WRITE(2,REC=6) (REC(I),I=1,3)
      DO 400 J=1,12*6*9
         READ(1,300) (REC(I),I=1,9)
         WRITE(2,REC=6+J) (REC(I),I=1,9)
  400 CONTINUE
C
