...
C
C  METHOD
C     The user is asked for the root name of an unformatted LME PIM database
C     file, the root name of the formatted LME PIM database files to be
...
C
C  FILES ACCESSED
C     Unit 1   Unformatted LME PIM database files
C     Unit 2   Formatted LME PIM database files
C
C  AUTHOR
C     Lincoln Brown
...
C
      ...
      DO 400 J=1,NEOF*24*12
         READ(1,REC=7+J) (REC(I),I=1,NOPM1+1)
         WRITE(2,300) (REC(I),I=1,NOPM1+1)
  400 CONTINUE
C
