...
C
C  METHOD
C     The user is asked for the root name of an formatted LLF PIM database
C     file and the root name of the unformatted LLF PIM database files to be
...
C
C  FILES ACCESSED
C     Unit 1   Formatted LLF PIM database files
C     Unit 2   Unformatted LLF PIM database files
C
C  AUTHOR
C     Lincoln Brown
...
C
  ...
  200 FORMAT(5E14.7)
      ...
      READ(1,200) (REC(I),I=1,55)
      WRITE(2,REC=7) (REC(I),I=1,55)
      READ(1,200) (REC(I),I=1,55)
      WRITE(2,REC=8) (REC(I),I=1,55)
      READ(1,200) (REC(I),I=1,55)
      WRITE(2,REC=9) (REC(I),I=1,55)
      DO 210 J=1,55
         READ(1,200) (REC(I),I=1,55)
         WRITE(2,REC=9+J) (REC(I),I=1,55)
  210 CONTINUE
C
...
C
      ...
      DO 300 J=1,48*9
         READ(1,200) (REC(I),I=1,15)
         WRITE(2,REC=7+J) (REC(I),I=1,15)
  300 CONTINUE
C
