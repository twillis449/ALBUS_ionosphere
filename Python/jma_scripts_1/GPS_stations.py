...
# http://igscb.jpl.nasa.gov/network/list.html, but this is an HTML format.
# NASA keeps a list at
# ftp://igscb.jpl.nasa.gov/pub/station/general/igs.snx
# But this one may be better:
# ftp://igscb.jpl.nasa.gov/pub/station/general/igs_with_former.snx
...
GPS_global_station_list = ['algo', 'alic', 'alrt', 'amc2', 'artu', 'asc1', 'aspa', 'bahr', 'bili', 'bjfs', 'bor1', 'braz', 'brus', 'cagl', 'cas1', 'cedu', 'chat', 'chpi', 'chur', 'coco', 'conz', 'cord', 'cro1', 'daej', 'darw', 'dav1', 'dgar', 'drao', 'dubo', 'flin', 'glps', 'glsv', 'gode', 'gold', 'gras', 'guam', 'guao', 'harb', 'hlfx', 'hnlc', 'hob2', 'hofn', 'holm', 'hrao', 'hyde', 'iisc', 'irkt', 'ispa', 'jab1', 'joze', 'karr', 'kely', 'kerg', 'kit3', 'kokb', 'kunm', 'lae1', 'lhaz', 'lpgs', 'mac1', 'madr', 'mali', 'mana', 'mas1', 'mate', 'maw1', 'mbar', 'mcm4', 'mdo1', 'mdvj', 'mets', 'nico', 'nklg', 'nlib', 'not1', 'noum', 'novj', 'nrc1', 'nril', 'nya1', 'nyal', 'ohi2', 'ohi3', 'onsa', 'pdel', 'pert', 'petp', 'pie1', 'pimo', 'pol2', 'polv', 'pots', 'qaq1', 'quin', 'rabt', 'ramo', 'reun', 'reyk', 'riog', 'sant', 'sch2', 'scub', 'sey1', 'sfer', 'stjo', 'suth', 'syog', 'thti', 'thu3', 'tidb', 'tixi', 'tow2', 'trab', 'tro1', 'trom', 'tskb', 'ulab', 'unsa', 'usno', 'vesl', 'vill', 'wes2', 'whit', 'will', 'wsrt', 'wtzr', 'wuhn', 'yar1', 'yell', 'zimm']
