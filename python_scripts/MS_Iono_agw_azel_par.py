...
def process_ionosphere(MSname="",MSdir=".", Ra=0, Dec=0, Az=180.0, El=-90.0, Lat=0, Long=0, Height=0,start_time="",end_time="", object="",time_step=300.0,telescope_pos=None,station_pos_x=0,station_pos_y=0,station_pos_z=0,processing_option="RI_G03",tolerance=0.1,overwrite=0,do_serial=0,raise_bias_error=0, num_processors=4,use_pim=1,use_global_data=0,gps_data_directory="."):
...
#   num_processors = 1
    ...
    if Ra == 0 and Dec == 0 and len(MS) > 0: 
      ...
      print ('observation direction ', direction, file=log)
