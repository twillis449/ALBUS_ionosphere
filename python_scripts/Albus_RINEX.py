...
_RINEX_SITE_LIST_ZA = ["anth","beni","beth","bftn","biso","brit","brnk","bwes","calv","cpnt","ctwn","dear","drba","elda","emlo","eras","gdal","geoa","geor","grey","grhm","grnt","heid","hnus","ixop","kley","kman","koks","krug","kstd","lgbn","lsmh","malm","mbrg","mfkg","mriv","nspt","newc","nyls","okny","pbwa","pelb","plet","plba","pmbg","potg","pret","pska","ptbg","qtwn","rbay","sbok","scot","skar","sprt","stbs","stng","suth","tdou","temb","uldi","umta","upta","verg","welk","worc","bfta","mtut","rust","secd","sosh","sbas"]
