...
//    const Uint32 NUM_SOURCES = NUM_3C_SOURCES;
    ...
    filter_on_El(40.0*M_DEG2RAD, 1E300, NUM_OBSERVATIONS, observation, use_flag);
...
//        if(((use_flag[i])) && (observation[i].object_number == 958))
        if((use_flag[i]))
            printf("Obs %6u Sta %3u Obj %3u Az %7.3f El %7.3f Lat %7.3f Lon %7.3f VTEC %8.3f Model %8.3f\n",
                   i,
